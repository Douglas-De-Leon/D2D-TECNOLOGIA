  ...
  return (
    <div className="flex flex-col h-full bg-sidebar text-gray-300 shadow-xl">
      ...
      <div className="p-4 border-t border-gray-700">
        <button className="flex w-full items-center px-3 py-2 text-sm font-medium text-gray-400 rounded-md hover:bg-sidebarHover hover:text-white transition-colors">
